...
export class AdminAnalyticsController {
  ...
  async getOverview(req: Request, res: Response): Promise<void> {
    console.log(
      '[AdminAnalyticsController] Starting getOverview with LIVE DATA...',
    );

    try {
      console.log(
        '[AdminAnalyticsController] Calling AnalyticsService.getOverview()...',
      );
      ...
      console.log(
        '[AdminAnalyticsController] ✅ Analytics service returned live data:',
        {
      ...
      console.log(
        '[AdminAnalyticsController] ✅ Live analytics data sent successfully',
      );
    } catch (error) {
      console.error(
        '[AdminAnalyticsController] ❌ Error in getOverview:',
        error,
      );

      if (error instanceof Error) {
        console.error(
          '[AdminAnalyticsController] Error message:',
          error.message,
        );
